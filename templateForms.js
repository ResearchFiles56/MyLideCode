// templateForms.js - テンプレートフォーム関連の処理
...
function showCustomizeForm(template) {
    ...
    switch (template) {
        case 'sequence':
            templateDescription.textContent = '日常の一連の行動を順番に実行するコードを作成します。各ステップを入力してください。ドラッグ&ドロップで順序を変更できます。';
...
function addSequenceStep() {
    ...
    stepItem.innerHTML = `
        ...
        <input type="text" class="form-control step-input" placeholder="例: 新しいステップ">
    `;
